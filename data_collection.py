...
# -------- CONFIGURATION --------
actions = ['age', 'ahlan w sahlan', 'alekom salam', 'alsalam alekom', 'alhamdulilah', 'bad', 'besm allah',
            'friend', 'good', 'happy', 'how are you', 'me', 'my name is', 'no',
              'null', 'or', 'taaban', 'what', 'where','yes', 'you', 'eat', 'did not hear', 'hospital'
              ,'kuliyah', 'look', 'night', 'remind me', 'run', 'sabah', 'said', 'sleep',
                'think', 'today', 'tomorrow', 'university', 'walking', 'when', 'yesterday', 'dhuhr', 'bayt']

sequence_length = 45  # Frames per sequence
num_sequences = 10  # Videos per action
data_path = Path('data_10')
start_folder = 70  # Start index for folder numbering
