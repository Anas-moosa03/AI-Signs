...
import 'schema/add_data_record.dart';
...
export 'schema/add_data_record.dart';
...
/// Functions to query AddDataRecords (as a Stream and as a Future).
Future<int> queryAddDataRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      AddDataRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<AddDataRecord>> queryAddDataRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      AddDataRecord.collection,
      AddDataRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<AddDataRecord>> queryAddDataRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
