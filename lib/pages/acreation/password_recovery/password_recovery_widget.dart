...
class _PasswordRecoveryWidgetState extends State<PasswordRecoveryWidget> {
  ...
  void initState() {
    ...
    _model.emailaddressRecoveryTextController ??= TextEditingController();
    _model.emailaddressRecoveryFocusNode ??= FocusNode();
  }
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                padding: EdgeInsetsDirectional.fromSTEB(16.0, 25.0, 16.0, 2.0),
                child: Text(
                  FFLocalizations.of(context).getText(
                    'hfij5b5z' /* We will send you an email with... */,
                  ),
              ...
              Padding(
                ...
                child: Container(
                  width: double.infinity,
                  child: TextFormField(
                    controller: _model.emailaddressRecoveryTextController,
                    focusNode: _model.emailaddressRecoveryFocusNode,
                    autofillHints: [AutofillHints.email],
                    obscureText: false,
                    decoration: InputDecoration(
                      labelText: FFLocalizations.of(context).getText(
                        'cnlgts2v' /* Your email address... */,
                      ),
                      labelStyle:
              ...
              Align(
                ...
                child: Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      if (_model
                          .emailaddressRecoveryTextController.text.isEmpty) {
                      ...
                      await authManager.resetPassword(
                        email: _model.emailaddressRecoveryTextController.text,
                        context: context,
                      );

                      context.pushNamed(EmailSentPageWidget.routeName);
                    },
