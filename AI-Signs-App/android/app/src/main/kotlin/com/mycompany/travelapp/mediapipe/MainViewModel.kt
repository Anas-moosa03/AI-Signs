...
class MainViewModel : ViewModel() {
    ...
    private var _delegate: Int = SignLandmarkerHelper.DELEGATE_CPU
    private var _minHandDetectionConfidence: Float =
        SignLandmarkerHelper.DEFAULT_DETECTION_CONFIDENCE
    private var _minHandTrackingConfidence: Float = SignLandmarkerHelper
        .DEFAULT_TRACKING_CONFIDENCE
    private var _minHandPresenceConfidence: Float = SignLandmarkerHelper
        .DEFAULT_PRESENCE_CONFIDENCE
    private var _maxHands: Int = SignLandmarkerHelper.DEFAULT_NUM_HANDS
